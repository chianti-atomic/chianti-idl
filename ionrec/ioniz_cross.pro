...
;
	...
	;
	y2=spline_init(x_spline(*,0),y_spline(*,0))
	btcross=spline_interp(x_spline(*,0),y_spline(*,0),y2,btev)
	...
	for ifac=1,nfac-1 do begin
		...
		if ngood gt 0 then begin
			...
			y2=spline_init(x_spline(*,ifac),y_spline(*,ifac))
			btcross=spline_interp(x_spline(*,ifac),y_spline(*,ifac),y2,btev)
