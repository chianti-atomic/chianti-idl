...
; 
; VERSION     :  22, 15-Jul-2011, Peter Young
;
; STILL TO DO: 
;
...
;      plot, lambda, effarea, psym=-3,syms=1.2,$
;        tit='Effective area file: '+f,  xtit= string(197B)  ,$
;        ytit='cm!S!E-2 !N ',chars=1.4, /yno
;      wait, 2
;      wshow,!d.window,0
;   END   
...
; ergs cm^3 s-1 str^-1 Ang^-1 per unit emission measure
    ...
    ;
      ...
      two_photon, temp,  lambda, two_phot,/no_setup,min_abund=min_abund, $
                  edensity=edensity, photons=photons, dem_int=dem_int,/sumt, $
                  VERBOSE=VERBOSE, kev=kev
