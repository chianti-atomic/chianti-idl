...
PRO itoh, temp, wvl, int, no_setup=no_setup, sumt=sumt, dem_int=dem_int, $
...
; KEYWORDS
;
;    NO_SETUP This keyword is obsolete now.
;
...
IF n_params() LT 3 THEN BEGIN
  print,'Use:  IDL> itoh, temp, wvl, int [, /no_setup, /sumt, /kev, '
