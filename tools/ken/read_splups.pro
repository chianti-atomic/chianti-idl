...
;
;       Ver.6, 31-Jan-2012, Ken Dere
;               can handle files with 5 through 9 spline pointer, maybe more
;
;-
...
WHILE tst1 EQ 0 DO BEGIN
  readf,lur,string1
  string1a = str2arr(strcompress(string1),' ')
  nsplups = n_elements(string1a) - 9
  nvar = n_elements(string1a)
  IF strcompress(string1,/rem) NE '-1' THEN BEGIN
    if keyword_set(prot) then begin
        ...
        splformat = '(5i3,'+string(nvar - 5)+'e10.0)'
