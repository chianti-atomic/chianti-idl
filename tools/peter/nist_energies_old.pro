...
PRO nist_energies_old, infile, outfile, add_empty_theo=add_empty_theo
...
;     NIST table be output in ASCII format. **This creates elvlc files
;     in the format for CHIANTI versions 7 and earlier.**
;
; INPUTS
;
...
;        This routine has been renamed nist_energies_old as it makes
;        files in the format used by CHIANTI 7 and earlier.
;-

IF n_params() LT 1 THEN BEGIN
  print,'Use: IDL> nist_energies_old, infile, outfile [ /add_empty_theo ]'
  return
ENDIF
