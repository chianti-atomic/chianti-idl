...
;        file format.
;     Ver.7, 23-Jun-2020, Peter Young
;        For call to burly_optimize_c, I've switched to
;        method=2 which prevents the points bunching up at high-T
;        values. This bunching led to inaccuracies in the descaled
;        temperature values that in turn led to discrepancies between
...
FOR i=0,n-1 DO BEGIN
 ...
 ;
  ...
  c_val=burly_optimize_c(temp,ups,de,ttype,method=2)
