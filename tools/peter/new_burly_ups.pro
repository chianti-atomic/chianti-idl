...
npt_but=cw_bgroup(base_right,['5 points','9 points'],font=font,$
...
;----------------
PRO new_burly_ups, directory,iz,ionn,proton=proton, diel=diel, cutoff=cutoff, $
                   meta=meta
...
IF n2 LT n1 THEN BEGIN
  print,'%BURLY_UPS: too many levels in .wgfa file. Returning...'
  return
ENDIF
...
IF n LT 9 THEN nspl=5 ELSE nspl=9
;
...
trans={l1: 0, l2: 0, gf: 0., de: 0., $
       ...
       masksave: 0, $
       c_ups: 0., hi: 0., $
       extrapstr: extrapstr, nspl: nspl, spl: fltarr(9), $
